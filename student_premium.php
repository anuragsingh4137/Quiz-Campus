...
<head>
  ...
  <style>
    ...
    .topbar { height:64px; background:var(--brand); color:#fff; display:flex; align-items:center; justify-content:space-between; padding:0 20px; position:sticky; top:0; z-index:50; }
    ...
    .title { font-size:26px; font-weight:800; display:flex; align-items:center; gap:12px; }
    .subtitle { color:var(--muted); margin-top:6px; }

    /* Card wrapper */
    .card { background:var(--card); border-radius:12px; padding:0; box-shadow:0 10px 30px rgba(2,6,23,0.04); border:1px solid var(--table-border); overflow:hidden; }

    /* Table styles */
    table.quizzes { width:100%; border-collapse:collapse; table-layout:fixed; }
    table.quizzes thead th { background:var(--brand); color:#fff; text-align:left; padding:16px 18px; font-weight:700; font-size:16px; border-bottom:1px solid rgba(255,255,255,0.06); }
    table.quizzes tbody td { padding:18px; border-top:1px solid var(--table-border); vertical-align:middle; color:#0f172a; }
    table.quizzes tbody tr:nth-child(even){ background:#fbfdff; }
    .quiz-title { font-weight:700; color:#111827; margin-bottom:6px; }
    .quiz-by { font-size:13px; color:var(--muted); margin-bottom:8px; }
    .badge-prem { display:inline-block; font-size:12px; padding:6px 10px; border-radius:999px; background: linear-gradient(90deg,#7c3aed,#a78bfa); color:#fff; font-weight:700; }
    .quiz-desc { color:var(--muted); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:520px; display:inline-block; vertical-align:middle; }
    .action-cell { text-align:left; width:160px; }
    .btn-start { background:transparent; border:none; color:var(--accent); font-weight:700; text-decoration:none; cursor:pointer; padding:8px 10px; border-radius:8px; }
    ...
    @media (max-width:640px) {
      ...
      table.quizzes, table.quizzes tbody, table.quizzes tr, table.quizzes td { display:block; width:100%; }
      table.quizzes tr { margin-bottom:12px; box-shadow:0 6px 18px rgba(2,6,23,0.03); border-radius:8px; overflow:hidden; background:#fff; }
      table.quizzes td { padding:12px 14px; border:0; display:flex; justify-content:space-between; align-items:center; }
      .quiz-desc { display:block; max-width:60%; white-space:normal; }
    ...
    .btn-start:hover { background: #1e4fcc; transform: translateY(-2px); }
  </style>
</head>
<body>
  <header class="topbar">
